    ...
    {window.innerWidth >= 700 && (
       ...
       <AppBar position="sticky" className='bnktheme app-barcurve'>
        ...
        <footer className={'fixed-buttom text-center text-dark bg-light pt-2'} style={{paddingBottom: window.innerWidth < 700 ? 70 :0}} ref={ref}>
          ...
          <br /> All BNK48 and CGM48 contents are licensed by Independent Artist Management (iAM). These member images and all events poster is objective for BNK48 supporting only.</p>
        </footer>
