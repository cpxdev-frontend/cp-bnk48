          ...
          <DialogContent>
            <CardContent>
             ...
             <p className='mt-1 mb-3'>
                This event has been started since {moment.unix(item.timerange[0]).format('ddd DD MMMM yyyy H:mm A')}
            </p>
            )}
             {item.timerange[0] > 0 && item.timerange[1] > 0 && item.timerange[0] < item.timerange[1] && (
             <p className='mt-1 mb-3'>
                This event has been started in {moment.unix(item.timerange[0]).format('ddd DD MMMM yyyy H:mm A')} to {moment.unix(item.timerange[1]).format('ddd DD MMMM yyyy H:mm A')}
            </p>
            )}
            <br />
              {
        ...
        <DialogContent>
          <CardContent>
            ...
            {newspop[0].timerange[0] > 0 && newspop[0].timerange[1] == 0 && (
             <p className='mt-1 mb-3'>
                This event has been started since {moment.unix(newspop[0].timerange[0]).format('ddd DD MMMM yyyy H:mm A')}
            </p>
            )}
             {newspop[0].timerange[0] > 0 && newspop[0].timerange[1] > 0 && newspop[0].timerange[0] < newspop[0].timerange[1] && (
             <p className='mt-1 mb-3'>
                This event has been started in {moment.unix(newspop[0].timerange[0]).format('ddd DD MMMM yyyy H:mm A')} to {moment.unix(newspop[0].timerange[1]).format('ddd DD MMMM yyyy H:mm A')}
            </p>
            )}
            <br />
            {
