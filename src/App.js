...
Dialog, DialogActions, Button, Fab, DialogTitle, DialogContent, Avatar, Badge, CardContent, CardMedia, Slide, Grow, Snackbar, BottomNavigation, BottomNavigationAction, TextField, Menu, MenuItem } from '@material-ui/core';
  ...
  if (uri != '' && allDone) {
    ...
    {window.innerWidth >= 700 && (
       ...
       <AppBar position="sticky" className='bnktheme app-barcurve'>
        ...
        <small>Copyright {new Date().getFullYear()}, CPXDevStudio Allright Reserved
        <br /> All BNK48 and CGM48 contents are licensed by Independent Artist Management (iAM). These member images and all events poster is objective for BNK48 supporting only.</small>
      </footer>
