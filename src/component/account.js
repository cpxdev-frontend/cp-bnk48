    ...
    const [customback, setBack] = React.useState(false);
        ...
        const Fetch= () => {
            if (localStorage.getItem('loged') != null) {
                fetch(fet + '/bnk48/membershipData?i=' + JSON.parse(localStorage.getItem('loged')).user.uid , {
                    method :'post'
                })
            ...
            <div className='mt-4 mb-3 row'>
                ...
                <div className='col-md pt-4'>
                    ...
                    {data.obj == null ? (
                        ...
                        <p>Your Kami-Oshi is <a className='cur' onClick={() => History.push('/member?name=' + data.obj.name.toLowerCase())}>{data.obj.fullnameEn[0]} {data.obj.fullnameEn[1]} ({data.obj.name} BNK48)</a></p>
                    )}
