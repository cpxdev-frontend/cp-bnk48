    ...
    return ( 
        <Card>
            <CardContent className={width > 700 ? 'pl-5 pr-5' : 'pl-2 pr-2'}>
                ...
                <hr />
                <p>We also serve BNK48 members profile on Public API service. Member profile contents which you see in website are using this service also. Please see our <a href='https://cp-apicenter.pages.dev/bnk48' target='_blank'>documentation</a> here</p>
                <hr />
