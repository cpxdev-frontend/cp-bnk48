               ...
               <CardContent className='row'>
                   ...
                   <div className='col-md mt-3'>
                       ...
                       {nearest.distance >= 25000 ? (
                        <p data-aos="zoom-in-right" className='mt-3'>The event is stay far ({(nearest.distance / 1000).toFixed(2)} kilometers). However, you can take a taxi or drive yourself and suggested to planning your trip ahead of time.</p>
