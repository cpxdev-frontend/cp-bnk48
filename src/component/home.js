...
const defaultTheme =
  "https://pbs.twimg.com/media/GsQz8k_aMAQj_HP?format=jpg&name=4096x4096";
const defaultvideo =
...
const HomeCom = ({ fet, gp, ImgThumb, stream, kamin, setSec, width }) => {
  ...
  React.useEffect(() => {
    ...
    fetch(
      fet +
        "/bnk48/getmemberby?filter=gen&param=" +
        ran +
        "&tstamp=" +
        Math.floor(new Date().getTime() / 1000),
      {
          ...
          <Card data-aos="zoom-in" className="col-md-4 m-5">
            <CardContent>
              ...
              <Typography color="textSecondary">
                This is your space for join with BNK48 fans around the world.
                Let's enjoy!
              </Typography>
              <hr />
      ...
      <div className="stage text-center pt-5 pb-2">
                      ...
                      <CardContent>
                        {ImgThumb != "" && stream != null && (
                          <Typography variant="subtitle1">
                            ...
                            BNK48 Youtube Official is ready and display to
        ...
        {onMonth ? (
          <CardHeader
            className="mb-5"
            title={
              <h3 data-aos="flip-up">BNK48 Members Birthday on this month</h3>
            }
          ...
          <CardHeader
            className="mb-5"
            title={<h3 data-aos="flip-up">BNK48 Members Birthday in today</h3>}
                  ...
                  <Card>
                    <CardActionArea>
                      ...
                      <CardContent>
                        ...
                        <p>
                          Birthday:{" "}
                          {moment(item.birthday, "YYYY-M-DD").format(
                            "DD MMMM YYYY"
                          )}{" "}
                          (
        ...
        {kamin != "" && kamin != "-" && (
          <>
            <CardHeader
              title={
                <h3 data-aos="flip-up">
                  Current BNK48 Members LIVE Streaming in IAM48 Application
                </h3>
              }
              className="mb-5"
            />
            {LIVEmem != null ? (
              <div className="row ml-3 mr-3 justify-content-center">
                ...
                LIVEmem.filter((x) => x.isLive == true).length > 0 ? (
                  ...
                  <h6>
                    No BNK48 member(s) LIVE right now. Please come back later.
                  </h6>
                )}
              </div>
            ) : (
