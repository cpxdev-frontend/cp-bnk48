...
import { Card, CardActionArea, CardContent, CardMedia, TextField, Zoom, FormControlLabel, Switch, Button, CardHeader, MenuItem, Backdrop } from '@material-ui/core';
...
const RegisterMember = ({fet, setSec}) => {
    ...
    const RegisterAPI = (obj) => {
        fetch(fet + '/bnk48/registerFanSpace', {
            method :'post',
